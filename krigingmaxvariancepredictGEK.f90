...
!> \file krigingmaxvariancepredictGEK.f90
!> \brief Subroutine to Predict maximum variance value from Gradient-Enhanced Kriging Surface (requires  <a href=buildkrigingGEK_8f90.html>buildkrigingGEK</a> to be called first) <br>
!>        Only Works for Ordinary Kriging (Constant Mean function)

!> \detail See documentation for <a href=krigingmaxvariancepredict_8f90.html>krigingmaxvariancepredict</a> for details. This subroutine is the gradient-enhanced version and is functionally the same as the function-only subroutine.
...
!> \param(out) <b> Sm </b>: Maximum Variance
...
subroutine krigingmaxvariancepredictGEK(ndim,ntot,X,gtot,pts,dims,stot,H,beta,V,hyper,Xm,Sm,covarflagi,optflag,Lb,Ub)
  ...
  return
end subroutine krigingmaxvariancepredictGEK
